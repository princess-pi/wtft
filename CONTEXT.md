...
skips that are *not* gaps — `already-counted` (a diamond, a cycle among descendants, or a session
a descendant's parse folded in, whose money landed once in `spawned.total`),
