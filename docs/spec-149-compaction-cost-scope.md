...
|---|---|---|
| **V1** | The harness runs against any logged session id by prefix and against `--all`, and exits 0. | `node research/149-cost-scope/paired-window-audit.mjs ee53e779` and `--all` |
